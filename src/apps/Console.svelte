<script>
    ...
    <div class="w-full h-full text-[#2c2cc9] rounded-lg overflow-hidden font-mono">
      <div class="overflow-y-auto h-full">
        ...
        <div class="flex items-center">
          <span class="text-[#2c2cc9] mr-2">&gt;</span>
          <input
            bind:this={inputElement}
            type="text"
            bind:value={inputValue}
            on:keydown={handleKeyDown}
            class="flex-1 bg-transparent outline-none text-[#2c2cc9]"
            spellcheck="false"
            autocomplete="off"
          />
        </div>
