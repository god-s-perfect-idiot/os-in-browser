<div class="flex w-full flex-col gap-4 p-2">
    ...
    <div class="flex flex-col gap-1">
        <span class="font-semibold">2. Is os in browser open source?</span>
    ...
    <div class="flex flex-col gap-1">
        <span class="font-semibold">3. How can I contribute to os in browser?</span>
    ...
    <div class="flex flex-col gap-1">
        <span class="font-semibold">4. How can I report a bug?</span>
    ...
    <div class="flex flex-col gap-1">
        <span class="font-semibold">5. Is my data collected?</span>
